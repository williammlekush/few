...
const quotesArray = Array.from(document.getElementById('quotes').getElementsByTagName('p'));
...
const poemsArray = Array.from(document.getElementById('poems').getElementsByTagName('p'));
